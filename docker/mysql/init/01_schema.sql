...
CREATE TABLE `burn_records` (
  ...
  `source_row_no` int NOT NULL DEFAULT '0' COMMENT '导入源文件行号',
...
CREATE TABLE `factory_tests` (
  ...
  `report_file_id` bigint NOT NULL DEFAULT '0' COMMENT '测试报告文件ID',
  `report_uploader_id` bigint NOT NULL DEFAULT '0' COMMENT '测试报告上传人ID',
  `report_uploader_name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '测试报告上传人',
...
CREATE TABLE `fault_analysis` (
  ...
  `reason` varchar(128) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '原因',
...
CREATE TABLE `inventory_devices` (
  ...
  `source_file_id` bigint DEFAULT '0' COMMENT '来源文件ID',
  `source_file_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '来源文件名称',
  `inbound_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '入库类型',
  `scrap_audit_status` varchar(32) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '废弃审核状态',
  `scrap_request_user_id` bigint DEFAULT '0' COMMENT '废弃申请人ID',
  `scrap_request_user_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '废弃申请人',
  `scrap_request_time` datetime DEFAULT NULL COMMENT '废弃申请时间',
  `scrap_audit_user_id` bigint DEFAULT '0' COMMENT '废弃审核人ID',
  `scrap_audit_user_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '废弃审核人',
  `scrap_audit_time` datetime DEFAULT NULL COMMENT '废弃审核时间',
  `scrap_reject_reason` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '废弃驳回原因',
...
CREATE TABLE `projects` (
  ...
  `has_server` tinyint NOT NULL DEFAULT '0' COMMENT '是否有服务器',
  `server_owner_id` bigint NOT NULL DEFAULT '0' COMMENT '服务器负责人ID',
  `server_owner_name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '服务器负责人',
